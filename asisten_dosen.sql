...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2016 at 10:36 AM
...
INSERT INTO `kelas` (`idKelas`, `namaKelas`, `idDosen`) VALUES
(1, '6PTI1 - Basis Data Enterprise ', 4),
(2, '6PTI2 - Basis Data Enterprise', 3),
(3, '6PTI3 - Basis Data Enterprise', 4);
...
--
ALTER TABLE `kelasdtl`
MODIFY `idKelasdtl` int(11) NOT NULL AUTO_INCREMENT;
--
